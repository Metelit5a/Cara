...
in this phase we worked on perfecting each his own architecture and achieving a high validation, and selecting the most suitable architecture, the book has to explain that and also explain our final decision

phase 3 is a the biggest phase because thats when we realised the results in real work test cases and trials (that we did) didnt sutify us, so we did a major redisgn of our datasets, did some fancy work arounds 
